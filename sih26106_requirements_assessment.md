...
| IP geolocation and map | Implemented conditionally | Analyst approval, public-IP eligibility gate, approximate `ipwho.is` lookup, private location storage, and supported marker-based multi-location map | Requires a real publicly routable source IP; private, reserved, and RFC 5737 documentation IPs are blocked |
