    ...
    <main className="landing-shell">
      ...
      <section id="team" className="team-section section-wrap">
        ...
        <div className="team-list">
          ...
          {[["Srinidhi H", "Backend Developer"], ["Sayasree T K", "R&D Engineer"], ["Surya V", "Frontend Developer"], ["Rohini S", "Frontend Developer"], ["Sankarprasath S", "Presenter"]].map(([member, role], index) => <div key={member} className="team-member"><span>0{index + 2}</span><div><strong>{member}</strong><small>{role}</small></div><i /></div>)}
        </div>
      </section>
