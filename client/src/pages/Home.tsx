...
function WorkspaceTopDock({ activeView, setActiveView, userName, signOut, openGuide }: { activeView: View; setActiveView: (view: View) => void; userName: string; signOut: () => void; openGuide: () => void }) {
